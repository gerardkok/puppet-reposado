...
describe 'os_minor_version' do
  ...
  it { is_expected.to run.with_params('10.15').and_return(15) }
  it { is_expected.to run.with_params('10.42').and_return(16) }
  ...
  it { is_expected.to run.with_params('catalina').and_return(15) }
  it { is_expected.to run.with_params('elsnowmountainsierra').and_return(16) }
end
